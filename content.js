function createBadgeRemoverInterval() {
...
function createMenuRemoverInterval() {
    return setInterval(() => {
...
const badgeIntervalId = createBadgeRemoverInterval();
const menuIntervalId = createMenuRemoverInterval();
